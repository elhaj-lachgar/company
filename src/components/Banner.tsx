...
function Banner() {
  ...
  return (
    <div id="home" className="relative flex flex-col text-gray-200 items-center  justify-center w-full h-[350px] md:h-[500px] lg:h-screen mt-[64px] lg:mt-0">
      <img
        src="/b_home.jpg"
      ...
      <div className="absolute top-[20%] right-auto flex flex-col gap-y-4 text-center">
        <h1 className=" text-xl md:text-6xl text-border-blue-1 md:text-border-blue-2   uppercase">{t('banner.title')}</h1>
